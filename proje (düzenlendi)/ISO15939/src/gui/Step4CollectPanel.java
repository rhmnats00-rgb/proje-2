...
/**
 * Step 4 — Collect: displays raw metric values and auto-calculated scores (1-5).
 */
public class Step4CollectPanel extends JPanel {
    ...
    public Step4CollectPanel(AppState state, MainFrame mainFrame) {
        this.state     = state;
    ...
    private void buildUI() {
        ...
        backBtn.addActionListener(e -> mainFrame.goToStep(2));

        JButton nextBtn = new JButton("Analyse ▶");
        styleButton(nextBtn, new Color(30, 100, 200));
        nextBtn.addActionListener(e -> mainFrame.goToStep(4));
    ...
    /** Reload data each time the panel becomes visible. */
    public void refresh() {
        ...
        for (model.Dimension dim : dimensions) {
            ...
            tsp.setPreferredSize(new java.awt.Dimension(740, table.getRowCount() * 28 + 28));
